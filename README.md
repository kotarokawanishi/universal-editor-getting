...
## Environments
- Preview: https://main--universal-editor-getting--kotarokawanishi.aem.page/
- Live: https://main--universal-editor-getting--kotarokawanishi.aem.live/
...
1. Open the `universal-editor-getting` directory in your favorite IDE and start coding :)
